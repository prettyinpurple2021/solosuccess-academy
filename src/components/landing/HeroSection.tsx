  ...
  return (
    <section className="relative overflow-hidden py-24 md:py-36 nebula-section">
      ...
      <div className="absolute inset-0 -z-10">
        <div
          className="absolute top-0 left-1/4 w-[600px] h-[600px] rounded-full blur-[150px] animate-orb-glow-primary will-change-[opacity]"
          style={{ background: 'hsl(270 100% 70% / 0.15)' }}
        />
        <div
          className="absolute bottom-0 right-1/4 w-[600px] h-[600px] rounded-full blur-[150px] animate-orb-glow-secondary will-change-[opacity]"
          style={{ animationDelay: '1s', background: 'hsl(185 100% 55% / 0.12)' }}
        />
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full blur-[200px] animate-orb-glow-accent will-change-[opacity]"
          ...
          <UIFrame className="inline-block p-6" scanline color="secondary">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Button
                size="lg"
                asChild
                className="text-lg px-10 h-14 btn-cyber bg-gradient-to-r from-[hsl(220_80%_55%)] to-[hsl(270_80%_55%)] text-primary-foreground shadow-[0_0_20px_hsl(245_80%_55%/0.4)] hover:shadow-[0_0_30px_hsl(245_80%_55%/0.5)] hover:scale-[1.02] transition-all duration-300"
              >
                <Link to="/courses">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 mt-16 pt-10 border-t border-primary/20 relative">
            ...
            {[
              ...
              <div key={stat.label} className="text-center group">
                <div className={`text-3xl font-display font-bold text-foreground ${stat.hoverColor} transition-colors`}>
                  {stat.value}
                </div>
