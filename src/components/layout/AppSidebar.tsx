            ...
            <SidebarGroupContent>
              <SidebarMenu>
                  ...
                  <SidebarMenuButton asChild>
                    <NavLink
                      ...
                      className={cn(
                        "flex items-center gap-3 px-4 py-2.5 rounded-lg transition-all duration-300",
                        "hover:bg-primary/10 hover:text-primary",
                        location.pathname === '/admin/projects' && "bg-primary/20 text-primary shadow-[inset_0_0_20px_hsl(270_80%_60%/0.1)] border-l-2 border-primary"
                      )}
                    >
                      <FolderCheck className="h-5 w-5 flex-shrink-0 text-accent drop-shadow-[0_0_6px_hsl(var(--accent)/0.5)]" />
                      {!collapsed && <span className="font-medium">Project Submissions</span>}
                    </NavLink>
                  </SidebarMenuButton>
                </SidebarMenuItem>
                {/* Unified grading dashboard: every student submission in one place */}
                <SidebarMenuItem>
                  <SidebarMenuButton asChild>
                    <NavLink
                      to="/admin/grading"
                      className={cn(
                        "flex items-center gap-3 px-4 py-2.5 rounded-lg transition-all duration-300",
                        "hover:bg-primary/10 hover:text-primary",
                        location.pathname === '/admin/grading' && "bg-primary/20 text-primary shadow-[inset_0_0_20px_hsl(270_80%_60%/0.1)] border-l-2 border-primary"
                      )}
                    >
                      <ClipboardCheck className="h-5 w-5 flex-shrink-0 text-primary drop-shadow-[0_0_6px_hsl(var(--primary)/0.5)]" />
                      {!collapsed && <span className="font-medium">Grading</span>}
                    </NavLink>
                  </SidebarMenuButton>
                </SidebarMenuItem>
                ...
                <SidebarMenuItem>
                  <SidebarMenuButton asChild>
                    <NavLink
                      to="/admin/blog-auto-post"
                      className={cn(
                        "flex items-center gap-3 px-4 py-2.5 rounded-lg transition-all duration-300",
                        "hover:bg-primary/10 hover:text-primary",
                        location.pathname === '/admin/blog-auto-post' && "bg-primary/20 text-primary shadow-[inset_0_0_20px_hsl(270_80%_60%/0.1)] border-l-2 border-primary"
                      )}
                    >
                      <Rss className="h-5 w-5 flex-shrink-0 text-info drop-shadow-[0_0_6px_hsl(var(--info)/0.5)]" />
                      {!collapsed && <span className="font-medium">Auto-Blog</span>}
                    </NavLink>
                  </SidebarMenuButton>
                </SidebarMenuItem>
                <SidebarMenuItem>
                  <SidebarMenuButton asChild>
                    <NavLink
                      ...
                      className={cn(
                        "flex items-center gap-3 px-4 py-2.5 rounded-lg transition-all duration-300",
                        "hover:bg-primary/10 hover:text-primary",
                        location.pathname === '/admin/migration' && "bg-primary/20 text-primary shadow-[inset_0_0_20px_hsl(270_80%_60%/0.1)] border-l-2 border-primary"
                      )}
                    >
                      <HardDriveDownload className="h-5 w-5 flex-shrink-0 text-warning drop-shadow-[0_0_6px_hsl(var(--warning)/0.5)]" />
                      {!collapsed && <span className="font-medium">Migration</span>}
                    </NavLink>
                  </SidebarMenuButton>
                </SidebarMenuItem>
                <SidebarMenuItem>
                  <SidebarMenuButton asChild>
                    <NavLink
                      ...
                      className={cn(
                        "flex items-center gap-3 px-4 py-2.5 rounded-lg transition-all duration-300",
                        "hover:bg-primary/10 hover:text-primary",
                        location.pathname === '/admin/testimonials' && "bg-primary/20 text-primary shadow-[inset_0_0_20px_hsl(270_80%_60%/0.1)] border-l-2 border-primary"
                      )}
                    >
                      <MessageSquareQuote className="h-5 w-5 flex-shrink-0 text-accent drop-shadow-[0_0_6px_hsl(var(--accent)/0.5)]" />
                      {!collapsed && <span className="font-medium">Testimonials</span>}
                    </NavLink>
                  </SidebarMenuButton>
                </SidebarMenuItem>
                <SidebarMenuItem>
