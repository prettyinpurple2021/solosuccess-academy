...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are an expert AI Tutor for the course "${courseTitle || 'Solo Founder Academy'}". 
You are currently helping a student with the lesson: "${lessonTitle || 'Current Lesson'}".
